...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->SetFillColor(8, 86, 141);
		$this->Rect(0, 0, 138, 32, 'F');
		$this->SetFillColor(0, 0, 0);
		$this->Rect(0, 0, 132, 28, 'F');
		$this->SetFillColor(8, 86, 141);
		$this->Rect(0, 0, 128, 24, 'F');

		$this->SetFillColor(8, 86, 141);
		$this->Rect(142, 0, 94, 32, 'F');
		$this->SetFillColor(0, 0, 0);
		$this->Rect(148, 0, 90, 28, 'F');
		$this->SetFillColor(8, 86, 141);
		$this->Rect(152, 0, 86, 24, 'F');
	}
	...
	{
		$this->SetFillColor(8, 86, 141);
		$this->Rect(0, 267, 220, 30, 'F');
		$this->SetY(20);
		$this->SetFont('Arial', 'B', 12);
		$this->SetTextColor(225, 225, 225);
		$this->Image(constant('URL') . 'controller/img/icon.png', 170, 273, 20, 20);
		$this->SetXY(10, 275);
		$this->Write(5, utf8_decode('Estamos Ubicados:' . ' Jr. Victor E. Chave  Barrio porteño '));
